...
class NetworkIcon(base._TextBox):
    ...
    defaults = [
        ...
        ("theme_path", "/home/gem/.config/qtile/icons/mojave", "Path of the icons"),
    ...
    def update(self):
        networkprocess = subprocess.Popen(['nmcli', '-f', 'state', 'nm'],
    ...
    def draw(self):
        if self.theme_path:
            ...
            if b'disconnected' in self.netstate:
                img_name = 'network-offline'
            elif b'connected' in self.netstate:
